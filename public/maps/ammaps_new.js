...
(function() {
    ...
    d.AmChart = d.Class({
        ...
        afterWrite: function(a) {
            if (a = "object" != typeof a ? document.getElementById(a) : a) {
                ...
                if (e) {
                    ...
                    if (e.enabled) switch (g.left = null, g.top = null, g.right = null, f.left = null, f.right = null, f.top = null, g.position = "relative", f.position = "relative", e.position) {
                        case "bottom":
                            k.appendChild(b);
                            k.appendChild(c);
                            break;
        ...
        initChart: function() {
            ...
            void 0 === this.pathToImages && (this.pathToImages = (base_url!='') ? base_url + 'assets/images/' : this.path + "images/");
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    n.innerHTML = '<div style="text-align:left; "' + y + "max-width:" + this.maxWidth + "px; font-size:" + B + "px; color:" + this.color + '">' + this.text + "</div>";
				//console.log('arijit: '+this.text);
				//n.innerHTML = this.text;
                    ...
                    this.drop ? (h = y / 1.6, l = 0, "V" == x && (x = "down"), "H" == x && (x = "left"), "down" == x && (w = a + 1, B = b - h - h / 3), "up" == x && (l = 180, w = a + 1, B = b + h + h / 3), "left" == x && (l = 270, w = a + h + h / 3 + 2, B = b), "right" == x && (l = 90, w = a - h - h / 3 + 2, B = b), k = B - E / 2 + 1, m = w - F / 2 - 1, q = d.drop(g, h, l, q, u, p, t, L)) : 0 < z || 0 === A ? (0 < G && (a = d.rect(g, y, v, q, 0, p + 1, D, G, z), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), q = d.rect(g, y, v, q, u, p, t, L, z)) : (r = [], z = [], "H" != x ? (h = a - w, h > y - A && (h = y - A), h < A && (h = A), r = [0, h - A, a - w, h + A, y, y, 0, 0], z = H ? [0, 0, b - B, 0, 0, v, v, 0] : [v, v, b - B, v, v, 0, 0, v]) : (x = b - B, x > v - A && (x = v - A), x < A && (x = A), z = [0, x - A, b - B, x + A, v, v, 0, 0], r = a < h + (l - h) / 2 ? [0, 0, w < a ? 0 : a - w, 0, 0, y, y, 0] : [y, y, w + y > a ? y : a - w, y, y, 0, 0, y]), 0 < G && (a = d.polygon(g, r, z, q, 0, p, D, G), a.translate(1, 1), f.push(a)), q = d.polygon(g, r, z, q, u, p, t, L));
                    this.bg = q;
                    f.push(q);
                    q.toFront();
...
(function() {
    ...
    d.polygon = function(a, b, c, e, g, f, h, k, l, m, n) {
        ...
        k = "M" + (h(b[0]) + n) + "," + (h(c[0]) + f);
        for (var r = 1; r < b.length; r++) m && (b[r] = d.roundTo(b[r], 5), c[r] = d.roundTo(c[r], 5)), k += " L" + (h(b[r]) + n) + "," + (h(c[r]) + f);
        a = a.path(k + " Z").attr(g);
    ...
    d.bullet = function(a, b, c, e, g, f, h, k, l, m, n, q, t) {
        ...
        switch (b) {
            ...
            case "square":
                r = d.polygon(a, [-c /
                    2, c / 2, c / 2, -c / 2
                ], [c / 2, c / 2, -c / 2, -c / 2], e, g, f, h, k, m - 180, void 0, t);
                break;
            case "rectangle":
    ...
    d.handDrawnLine = function(a, b, c, e, g, f, h, k, l, m) {
        ...
        for (n = 1; n < b.length; n++)
            for (var t = [b[n - 1], b[n]], r = [c[n - 1], c[n]], r = d.makeHD(t, r, a.handDrawScatter), t = r[0], r = r[1], p = 1; p < t.length; p++) q.push(d.line(a, [t[p - 1], t[p]], [r[p - 1], r[p]], e, g, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
        return q
    };
    d.doNothing =
        function(a) {
    ...
    d.wedge = function(a, b, c, e, g, f, h, k, l, m, n, q, t, r) {
        ...
        var z = 1 / 180 * Math.PI,
            ...
            B = b + Math.sin(e * z) * f,
            C = c - Math.cos(e * z) * h,
            w = b + Math.sin((e + g) * z) * f,
            y = c - Math.cos((e + g) * z) * h,
            F = b + Math.sin((e + g) * z) * k,
            z = c - Math.cos((e + g) * z) * u,
            E = {
        ...
        if (0 < l) {
            ...
            l = a.path(" M" + w + "," + y + " L" + w + "," + (y + l) + " L" + F + "," + (z + l) + " L" + F + "," + z + " L" + w + "," + y + " Z", void 0, void 0, "1000,1000").attr(E);
            e.push(D);
            e.push(l)
        }
        ...
        a.handDrawn && (k = d.line(a, [x, B], [v, C], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]), e.push(k));
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            for (v = 0; v < x.length; v++) {
                ...
                z = F.getBBox();
                var E;
                this.equalWidths ? E = B * (t + n + this.markerLabelGap) : (E = C, C = C + z.width + f + n);
            ...
            c.toBack();
            b = f;
            if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a) "center" == this.align ? b = f + (n - z.width) / 2 : "right" == this.align && (b = f + n - z.width);
            A.translate(b, m + 1);
        ...
        createValue: function(a) {
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (b.valueText && 0 < b.valueWidth) {
                    ...
                    var k = b.valueText,
                        g = g + b.lx + b.markerLabelGap + b.valueWidth,
                        l = "end";
    ...
    d.AmMap = d.Class({
        ...
        handleMouseMove: function(a) {
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if (a = b.mapContainer) {
                    ...
                    if (!isNaN(k)) {
                        b.stopDrag();
                        var r = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - f, 2)),
                            p = b.initialDistance;
        ...
        returnInitialColorReal: function(a) {
            ...
            if (b) {
                ...
                "MapArea" == a.objectType && (c = 1, this.areasSettings.adjustOutlineThickness && (c = this.zoomLevel() * this.mapScale), b.setAttr("stroke", h), b.setAttr("stroke-width", f / c), b.setAttr("fill-opacity", e), b.setAttr("stroke-opacity", d));
        ...
        clickMapObject: function(a, b) {
            ...
            if (c.chartCreated && !c.preventHover && c.checkTouchDuration() && !c.mapWasDragged && c.checkIfClickable(a) && !c.mapWasPinched) {
                c.selectObject(a);
                var d = c.zoomLevel(),
                    g = c.mapSet.getBBox(),
                ...
                for (g = 0; g < k; g++) {
                    ...
                    if (0 !== f.childNodes.length || "" !== m || !1 !== n)
                        ...
                        if (f.attributes && f.attributes.length)
                            for (m = 0; m < f.attributes.length; m++) q[f.attributes[m].name] = f.attributes[m].value;
        ...
        fixMapPosition: function() {
            ...
            c = f = Infinity;
            for (e = 0; e < this.svgAreas.length; e++) g =
        ...
        xyToCoordinates: function(a, b, c, e, g) {
            ...
            if (f = c.invert) {
                var h = this.dataProvider.leftLongitude,
                    ...
                    n = h + (k - h) / 2,
                    q = l + (m - l) / 2,
                    l = d.radiansToDegrees(c(d.degreesToRadians(n),
                        d.degreesToRadians(l))[1]),
    ...
    d.ZoomControl = d.Class({
        ...
        init: function(a, b) {
            ...
            if (f) {
                ...
                F.push(D);
                for (G = 1; G < H; G++) y = g + G * f, y = d.line(b, [1, E - 2], [y, y], c.gridColor, c.gridAlpha, 1), d.setCN(a, y, "zoom-grid"), D.push(y);
    ...
    d.AreasProcessor = d.Class({
        ...
        createArea: function(a) {
            ...
            var f = e.color,
                ...
                u = e.selectable,
                A = e.pattern,
                x = e.rollOverOutlineColor,
                z = e.bringForwardOnHover,
    ...
    d.ImagesProcessor = d.Class({
        ...
        createImage: function(a, b) {
            ...
            if (F) {
                ...
                D.translate(z, p, n, !0)
            } else x ? (isNaN(C) && (C = 10), isNaN(E) && (E = 10), D = e.image(x, 0, 0, C, E), D.node.setAttribute("preserveAspectRatio", "none"), D.setAttr("opacity", k), a.centeredReal && (z = isNaN(a.right) ? -C / 2 : C / 2, p = isNaN(a.bottom) ? -E / 2 : E / 2, D.translate(z, p, NaN, !0))) : A && (D = e.path(A), F = D.getBBox(), a.centeredReal ? (z = -F.x * n -
...
(function() {
    ...
    d.LinesProcessor = d.Class({
        ...
        createLine: function(a, b) {
            ...
            a.mouseEnabled && c.addObjectEventListeners(y, a);
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                p = n.length;
                if (0 < p)
                    for (v = [], C = [], x = 0; x < p; x++) A = c.coordinatesToXY(n[x], e[x]), v.push(A.x), C.push(A.y);
                if (0 < v.length) {
                    a.segments = v.length;
                    d.dx = 0;
                    d.dy = 0;
                    ...
                    if ("none" != B) {
                        var I, M, N;
                        if ("end" == B || "both" == B) x = v[v.length - 1], D = C[C.length - 1], 1 < v.length ? (A = v[v.length - 2], I = C[C.length - 2]) : (A = x, I = D), I = 180 * Math.atan((D - I) / (x - A)) / Math.PI, isNaN(E) || (I += E), M = x, N = D, I = 0 > x - A ? I - 90 : I + 90;
                        r = [-t / 2 - .5, -.5, t / 2 - .5];
                        k = [t, -.5, t];
                        ...
                        if ("start" == B || "both" == B) t = v[0], N = C[0], 1 < v.length ? (x = v[1], M = C[1]) : (x = t, M = N), I = 180 * Math.atan((N - M) / (t - x)) / Math.PI, isNaN(E) || (I -= E), M = t, I = 0 > t - x ? I - 90 : I + 90;
...
(function() {
    ...
    d.normalizePath = function(a) {
        for (var b = "", c = d.parsePath(a.getAttribute("d")), e, g, f = Infinity, h = -Infinity, k = Infinity, l = -Infinity, m = 0; m < c.length; m++) {
            ...
            "v" == q && (q = "L", t = e, n += g);
            "V" == q && (q = "L", t = e);
            if ("m" === q || "l" === q) q = q.toUpperCase(), t += e, n += g;
            t = d.roundTo(t, 3);
            n = d.roundTo(n, 3);
            e = t;
            g = n;
    ...
    d.winkel3.invert = function(a, b) {
        ...
        do var h = Math.cos(e),
            ...
            p = r * r,
            u = 1 - n * t * t,
            A = u ? d.acos(h * t) * Math.sqrt(x = 1 / u) : x = 0,
            x, u = .5 * (2 * A * h * r + c / f) - a,
            z = .5 * (A * k + e) - b,
            v = .5 * x * (n * p + A * h * t * m) + .5 / f,
            B = x * (q * l / 4 - A * k * r),
            k = .125 * x * (l * r - A * k * n * q),
            m = .5 * x * (m * t + A * p * h) + .5,
            h = B * k - m * v,
            ...
            u = (u * k - z * v) / h,
            c = c - B,
            e = e - u; while ((1E-6 < Math.abs(B) || 1E-6 < Math.abs(u)) && 0 < --g);
        return [c, e]
    };
